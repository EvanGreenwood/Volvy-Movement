...
namespace Framework
{
    ...
    public static class EditorUtils
    {
        ...
        public static GameObject GetPrefabAsset(GameObject gameObject, bool outermost)
        {
            ...
            {
                return AssetDatabase.LoadAssetAtPath<GameObject>(stage.prefabAssetPath);
            }
        ...
        public static bool TryDeserializeFromClipboard<T>(out T value)
        {
            try
            {
                ...
                JSONObject json = new JSONObject(EditorGUIUtility.systemCopyBuffer);
                value = deserializer.Deserialize<T>(json);
