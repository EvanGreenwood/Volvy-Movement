...
{
    public float LastPlayedTime { get { return _lastPlayedTime; } }
    public float TimeSinceLastPlayed { get { return GetCurrentTime() - _lastPlayedTime; } }
    public SoundInstance LastPlayedSound { get { return _lastPlayedSound; } }
    ...
    {
        UnityEditor.Selection.activeObject = DefaultSoundBankValues.Instance;
    }
#endif
...
public static class SoundBankExtenstions
{
    ...
    public static SoundInstance Play(this SoundBank soundBank)
    {
        ...
        sound = (soundBank as ImpactSoundBank).Play();
        if (sound != null) return sound;
    ...
    public static SoundInstance Play(this SoundBank soundBank, Vector3 position)
    {
        ...
        sound = (soundBank as ImpactSoundBank).Play(position, 1000);
        if (sound != null)
        {
            Debug.LogError("No velocity for impact sound");
            return sound;
        }
    ...
    public static SoundInstance Play(this SoundBank soundBank, Transform followTransform)
    {
        ...
        sound = (soundBank as ImpactSoundBank).Play(followTransform);
        if (sound != null) return sound;
