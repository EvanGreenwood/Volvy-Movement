...
public class BlendSoundInstance : MultiSoundInstance
{
    ...
    public float BlendParameter { get { return _blendParameter; } set { SetBlendParameter(value); } }
    public ReadOnlyCollection<SoundInstance> Layers { get { return _layerSounds.AsReadOnly(); } }
    public ReadOnlyCollection<BlendSoundBank.LayerData> LayerData { get { return _layerData.AsReadOnly(); } }
    public int NumLayers { get { return _layerSounds.Count; } }
