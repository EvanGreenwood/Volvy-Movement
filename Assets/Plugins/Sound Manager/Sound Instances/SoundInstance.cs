...
public abstract class SoundInstance : MonoBehaviour
{
    ...
    /// </summary>
    public float VolumeMultiplier { get { return _volumeMultiplier; } set { SetVolumeMultiplier(value); } }
    /// <summary>
    /// A mulitplier value that can be used to affect the final playing pitch of the sound.
    /// </summary>
    public float PitchMultiplier { get { return _pitchMultiplier; } set { SetPitchMultiplier(value); } }

    public bool HasFinished { get { return _hasFinished; } }
    public bool IsFadingIn { get { return _fadeSpeed > 0; } }
    public bool IsFadingOut { get { return _fadeSpeed < 0; } }

    /// <summary>
    /// Whether or not this sound is currently residing in the pool.
    /// </summary>
    public bool IsPooled { get { return _state == State.Pooled; } }

    /// <summary>
    /// Whether or not the sound is currently playing. Will return false if the sound is waiting for a delayed play.
    /// </summary>
    public bool IsPlaying { get { return _state == State.Playing; } }
    ...
    public bool IsPersistant { get { return _isPersistant; } set { SetPersistant(value); } }
    public AudioMixerGroup MixerGroup { get { return _mixerGroup; } set { SetMixerGroup(value); } }
    public bool AutoDestroy { get { return _autoDestroy; } set { SetAutoDestroy(value); } }
    public bool IsDelayed { get { return _delayTimer > 0f; } }
    public float CurrentDelay { get { return _delayTimer; } set { SetDelay(value); } }
    ...
    {
        UpdateSound(Time.unscaledDeltaTime);
    }
    ...
    public virtual SoundInstance LerpVolumeMultiplier(float target, float speed)
    {
        ...
        _volumeMultiplier = Mathf.Lerp(_volumeMultiplier, Mathf.Clamp01(target), Time.unscaledDeltaTime * speed);
