...
public class EffectSoundInstance : SoundInstance
{
    ...
    public AudioClip Clip { get { return _audioSource.clip; } set { SetClip(value); } }

    public float Time { get { return _audioSource.time / _audioSource.pitch; } set { SetTime(value); } }
    public float NormalizedTime { get { return Time / Length; } set { SetNormalizedTime(value); } }
    public float Length { get { return _audioSource.clip == null ? 0 : _audioSource.clip.length / _audioSource.pitch; } set { SetLength(value); } }
    public float TimeRemaining { get { return Length - Time; } set { SetTimeRemaining(value); } }

    public bool IsLooping { get { return _audioSource.loop; } set { SetLooping(value); } }

    public FloatRange RolloffDistance { get { return new FloatRange(_audioSource.minDistance, _audioSource.maxDistance); } set { SetRolloffDistance(value.Min, value.Max); } }
    ...
    /// </summary>
    public float BaseVolume { get { return _baseVolume; } set { SetBaseVolume(value); } }
    /// <summary>
    ...
    /// </summary>
    public float BasePitch { get { return _basePitch; } set { SetBasePitch(value); } }
    /// <summary>
    ...
    public override void UpdateSound(float deltaTime)
    {
        ...
        if (_state == State.Playing)
        {
            ...
            _audioSource.volume = Framework.MathUtils.GetLogarithmicVolume(GetCurrentVolume());
