...
public class ClipOrBankEditor : PropertyDrawer
{
    public override void OnGUI(Rect totalRect, SerializedProperty property, GUIContent label)
    {
        ...
        isBankProperty.boolValue = EditorGUI.Popup(iconRect, new GUIContent(""), isBankProperty.boolValue ? 0 : 1, new[] { new GUIContent(" Sound Bank"), new GUIContent(" Audio Clip") }, GUI.skin.GetStyle("PaneOptions")) == 0;
