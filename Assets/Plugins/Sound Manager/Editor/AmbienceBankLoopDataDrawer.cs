...
public class AmbienceBankLoopDataDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        if (!property.FindPropertyRelative("_initialized").boolValue)
        {
            ...
            property.FindPropertyRelative("RolloffDistance").SetValue(DefaultSoundBankValues.Instance.AmbienceBank.LoopRolloffDistance);
            property.FindPropertyRelative("VolumeVariationRange").SetValue(DefaultSoundBankValues.Instance.AmbienceBank.LoopVariationVolumeRange);
            property.FindPropertyRelative("VaritaionFrequency").SetValue(DefaultSoundBankValues.Instance.AmbienceBank.LoopVaritaionFrequency);
